...
<head>
    <meta charset="UTF-8">
    <title>Teste Prático CodeIgniter 4!</title>
...
<body>
    ...
    <header>
        ...
        <div class="heroe">
            ...
            <div class="content">
                <h1><strong>Bem-vindos à minha API com CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?></strong></h1>

                <h3>Abaixo você encontrará o link para a documentação dos endpoints usando Swagger</h3>
                <p>Espero que o resultado impressione!</p>

                <a href="documentacao" target="_blank"><button class="button-doc">Documentação da API com Swagger</button></a>
            </div>
    ...
    <section>
        ...
        <div class="endpoints">
            <div class="one">
                <h2>GitHub</h2>
                <p>Para acessar ao repositório e ao <strong>README</strong>. Aqui você vai conseguir acompanhar um pouquinho do meu trabalho e analisar alguns dos meu projetos.</p>
